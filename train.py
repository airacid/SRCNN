...
flags.DEFINE_string("checkpoint_dir",
					"/media/airacid/Data/project/3_SRCNN/checkpoint",
					"Name of checkpoint directory [checkpoint]")
flags.DEFINE_string("sample_file",
					"/media/airacid/Data/project/3_SRCNN/Test/Set5"
					"/butterfly_GT.bmp",
					"Name of sample directory [sample]")
flags.DEFINE_string("sample_dir",
					"/media/airacid/Data/project/3_SRCNN/"
					,
					"Name of sample directory [sample]")
...
def main(_):
	...
	srcnn = SRCNN(image_size=FLAGS.image_size,
				  ...
				  sample_dir=FLAGS.sample_dir, FLAGS=FLAGS)
	srcnn.call()
